...
var TaipeiDOM       = "htsai@, jdai@, bhsu@, sawang@, ttung@, \
                       sshih@mozilla.com, echuang@, alchen@, shuang@mozilla.com, btian@, \
                       jjong@, btseng@, echen@";
var TaipeiSecurity  = "ettseng@, tnguyen@, cfu@, tihuang@, jhao@, \
                       dlee@, hchang@, allstars.chh@";
var TaipeiNetwork   = "swu@, xeonchen@, amchung@, kechang@, juhsu@, \
                       schieng@";

var TaipeiLayout    = "aschen@, tokuo@, fatseng@, lochang@, ywu@, \
                       jeremychen@, slyu@, cku@, etsai@, boris.chiou@, \
                       tlin@mozilla.com, cmccormack@";
var TaipeiGraphic   = "howareyou322@, dmu@, ethlin@, cleu@, kechen@, \
                       brsun@, mtseng@, hshih@, vliu@";
var TaipeiMedia     = "bwu@, alwu@, cchang@, jacheng@, mchiang@, \
                       kaku@, kikuo@, jolin@, ayang@, jwwang@, bechen@";
var TaipeiPerf      = "kchen@, wpan@, janus926@, cyu@, wiwang@";

var TaipeiFrontend1 = "ehung@, fliu@, selee@, lchang@, kmlee@";
var TaipeiFrontend2 = "timdream@, ralin@mozilla.com, evan@tseng.io, gasolin@, rchien@, \
                       scwwu@, schung@";
